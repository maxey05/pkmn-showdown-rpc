...
public abstract class Pipe {
    ...
    {
        // NOTE: upstream jagrosh/DiscordIPC uses "\\?\pipe\discord-ipc-" here, but Java's
        // RandomAccessFile cannot resolve the "\\?\" extended-length prefix for named pipes on
        // Windows (it throws FileNotFoundException even though the pipe exists) -- "\\.\pipe\"
        // works with the same live pipe, so we shadow this class with that one-line fix.
